...
if ( buildStatus == "SUCCESS" ) {
 ...
 sparkSend ( credentialsId: 'sparkbot',  message: ' success - ${JOB_NAME}-${BUILD_NUMBER} - ${BUILD_RESULT} - ${JOB_URL}', messageType: 'markdown', spaceList: [[spaceId: '${id}', spaceName: 'common']] ) 
}
  else if( buildStatus == "FAILURE" ) { 
sparkSend ( credentialsId: 'sparkbot',  message: 'failure - ${JOB_NAME}-${BUILD_NUMBER} - ${BUILD_RESULT} - ${JOB_URL}', messageType: 'markdown', spaceList: [[spaceId: '${id}', spaceName: 'common']] )
  }
